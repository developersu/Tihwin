...
[![Rusia](flag/ru-flag.svg)](README.ru.md)
[![Spanyol](flag/es-flag.svg)](README.es.md)
[![Jepang](flag/jp-flag.svg)](README.ja.md)
[![Ryukyuan](flag/jp-flag.svg)](README.ryu.md) (Ryukyuan)
...
GNU GLPv3 atau versi yang lebih baru. Silakan lihat berkas LICENSE untuk informasi lengkap.
...
Kita semua tahu bahwa bahasamu adalah yang terbaik! Karena itu, kamu bisa membantu dengan membuat **Pull Request (PR)** atau **Issue** yang berisi terjemahan berkas `.../src/main/resources/locale.properties` ke dalam bahasamu.
